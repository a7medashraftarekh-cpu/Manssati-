import { renderHeader, renderFooter } from "./nav.js?v=5";
import { auth, createUserWithEmailAndPassword, updateProfile, db, doc, setDoc, serverTimestamp } from "./firebase-config.js?v=5";
